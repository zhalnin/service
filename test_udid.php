...
//    $title          = $unlockParent->getName();
    $title = "Регистрация UDID в аккаунте разработчика";
            ...
            <div id="showcase" class="content">
                <div id="design">
                    <div class="row block grid2col row block border">
                        <img class="hero-image flushleft" alt="Регистрация UDID в аккаунте разработчика" src="imei_service/view/images/udid/udid.png" width="256" height="192">
                        <div class="column last" style="z-index: 2;">
                            ...
                            <div class='column last dividerdownmidi'>
                                ...
                                echo "<div style='clear:both'>
                                        ...
                                        <div style='width: 150px; float: left; margin: 10px 0 0 60px;' id='timeconsume'>".printPrice(100)."</div>
                                    ...
                                    <div style='clear:both'>
                                        <div style='width: 160px; float: left; margin: 10px 0 0 30px; font-size: 11pt' id='operator'><ins><b>От 5 UDID единовременно</b></ins></div>
                                        <div style='width: 183px; float: left; margin: 10px 0 0 22px;' id='compatible'>iPad/iPhone/iPod Touch</div>
                                        <div style='width: 150px; float: left; margin: 10px 0 0 60px;' id='timeconsume'>".printPrice(50)." (1 ед.)</div>
                                        <div style='width: 260px; float: left; margin: 10px 0 0 10px;' id='timeconsume'>3 минуты<span class='buynow'><a style='display:block;' href='#' title='Для выбора кликните на названии и лот будет добавлен в корзину' >купить</a></span></div>
                                    </div>
                                    <div style='clear:both'>
                                        <div style='width: 160px; float: left; margin: 10px 0 0 30px; font-size: 11pt' id='operator'><ins><b>Сертификат + Профиль</b></ins></div>
                                        <div style='width: 183px; float: left; margin: 10px 0 0 22px;' id='compatible'>iPad/iPhone/iPod Touch</div>
                                        <div style='width: 150px; float: left; margin: 10px 0 0 60px;' id='timeconsume'>".printPrice(100)."</div>
                                        <div style='width: 260px; float: left; margin: 10px 0 0 10px;' id='timeconsume'>3 минуты<span class='buynow'><a style='display:block;' href='#' title='Для выбора кликните на названии и лот будет добавлен в корзину' >купить</a></span></div>
                                    </div>
                                    <div style='clear:both'>
                                        <div style='width: 160px; float: left; margin: 10px 0 0 30px; font-size: 11pt' id='operator'><ins><b>Регистрация + Сертификат + Профиль</b></ins></div>
                                        <div style='width: 183px; float: left; margin: 10px 0 0 22px;' id='compatible'>iPad/iPhone/iPod Touch</div>
                                        <div style='width: 150px; float: left; margin: 10px 0 0 60px;' id='timeconsume'>".printPrice(200)."</div>
                                        <div style='width: 260px; float: left; margin: 10px 0 0 10px;' id='timeconsume'>3 минуты<span class='buynow'><a style='display:block;' href='#' title='Для выбора кликните на названии и лот будет добавлен в корзину' >купить</a></span></div>
                                    </div>";
