            ...
            <div id="showcase" class="content">
                <div id="design">
                    <div class="row block grid2col row block border">
                        <img class="hero-image flushleft" alt="Проверка по IMEI iPhone" src="imei_service/view/images/imei/imei.png" width="256" height="192">
                        <div class="column last" style="z-index: 2;">
                            <h1><a href=<?php echo $_SERVER[PHP_SELF].'/'?>>Проверка iPhone по IMEI</a></h1>
                            <div class='column last dividerdownmidi'>
                                ...
                                echo "<div>
                                        <div style='width: 180px; float: left; margin: 10px 0 0 0px; font-size: 11pt' id='operator'><ins><b>Полная проверка GSX</b></ins></div>
                                        <div style='width: 163px; float: left; margin: 10px 0 0 52px;' id='compatible'>iPhone/iPad</div>
                                        <div style='width: 150px; float: left; margin: 10px 0 0 60px;' id='timeconsume'>".printPrice(30)."</div>
