...
abstract class ClientMail extends Mail {
    ...
    function email($email,$email_client,$imei,$udid,$type){
        ...
        $bottom =       "
                            ...
                            <br/>
                            <p>После оплаты обязательно ответьте на email: <a href=\"mailto:$email\">$email</a> с указанием способа оплаты, подтверждением (скан чека, номер транзакции)</p><br/><br/>";
        $footer =
                        "</div>
                        <div id=\"slice\"></div>
                    </div>
        ...
        switch($type){
            case 'udid':
                ...
                $middle = "<div class=\"main_txt\">
                             ...
                             <p>Которая вам обойдется в 200 рублей для зарегистрированных пользователей форума apple-iphone.ru,<br/>
                             для остальных желающих - 250 рублей. Оплатить вы можете любым из следующих способов:</p>";
