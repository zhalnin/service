    ...
    <div id="showcase" class="content">
        <div id="design" class="success">
            <a class="row block grid2col row block border" href="index.php" >
                <img class="hero-image flushleft logo" alt="IMEI-service - Заявка на проверку iPhone по IMEI" src="images/Apple_logo_black_shadow.png">
