...
if( $_SESSION['cart'] ) {
//    echo "<tt><pre>".print_r($_SESSION['cart'], true)."</pre></tt>";
?>
...
//            echo "<tt><pre>".print_r($product, true)."</pre></tt>";
        ?>
            <tr>
                ...
                <td> rub <?php echo number_format( $product['price'], 2); ?></td>
                <td><input type="text" size="2" maxlength="2" name="<?php echo $id; ?>" value="<?php echo $qty; ?>"/></td>
                <td> rub <?php echo number_format( $product['price'] * $qty, 2); ?></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
...
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="return" value="http://zhalnin.tmweb/gamelist/index.php?view=thankyou">
