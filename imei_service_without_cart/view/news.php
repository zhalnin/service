...
//    $title = "Регистрация UDID iOS 8, официальный анлок iPhone, проверка по IMEI, Blacklist";
    ...
    // содержимое тега meta
    $description = "Официальный анлок iPhone позволит вам обновлять ваш аппарат в iTunes. Регистрация UDID в аккаунте разработчика нужен для безопасной установки iOS 8 бета. iPhone.
