...
try {
    ...
    $sid_add_message = $_POST['sid_add_message']; // получаем id сессии
    $email = "value='".$_POST['email']."'"; // получаем email

    // содержимое тега title
    $title = "Запрос повторной отправки кода активации учетной записи";
        ...
        <div id="showcase" class="content">
            <div class="hero selfclear">
                <div id="shipping-box" class="box box-nomargin shipping-box ptn">
                    ...
                    <h2 id="shipping-box-title" class="heading primary" style="opacity: 1;"><a href="?cmd=FLogin">Запрос повторной отправки кода активации учетной записи</a></h2>
                            ...
                            <div id="shipping-contact-form" class="step-mode edit clearfix" autocomplete="off" style="">
                                <div class="gs grid-1of2" style="position: static;">
                                    <div id="shipping-user" class="user-form-block substep" style="">
                                        <form method="post" id="ractivation-form">
                                            <fieldset class="US first user-form-fieldset" style="">
                                                <legend style="">
                                                    <strong class="label">Выслать повторно код активации на указанный email</strong>
                                                </legend>
                                                ...
                                                <input id="type" type="hidden" name="type" value="ractivation">
                                                <input type="hidden" name="sid_add_message" value="<?php print $sid_add_message; ?>" />
                                ...
                                <div class="gs grid-1of3 gs-last fdescr fbl" style=" position: static;">
                                    <div class="substep" style="">
                                        <div id="payment-form-astro" class="form-astro with-seperator">
                                            ...
                                            <br />
                                            <p>
                                                Если вы не получили на, указанный при регистрации email, письмо с кодом активации, то вы можете запросить его повторную отправку.
                                            </p>
                                            <p>
                                                Для этого вам необходимо ввести адрес email и через несколько минут вы получите письмо с кодом активации.
                                            </p>
