...
?>
    ...
    <div id="header">
        <ul id="navigation" role="navigation">
            ...
            <li id="nav-carrier"><a class="selected" href="carrier_check.php"><span>Проверка оператора по IMEI</span></a></li>
                ...
                <div class='news-container'>
                    <div class='success-body'>
                        ...
                        <div class='success-image'>
                            <img alt='IMEI-service - Заявка на проверку iPhone по IMEI' src='images/Apple_logo_black_shadow.png'/>
                        </div>
