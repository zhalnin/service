...
class UdidDetails  extends DomainObject {
    ...
    static function findAll( $id ) {
        ...
        $unlockIdobj = new \imei_service\mapper\UdidDetailsIdentityObject( 'id_catalog' );
    ...
    static function find( $id ) {
        $finder = self::getFinder( __CLASS__ );
        $idobj = new \imei_service\mapper\UdidDetailsIdentityObject( 'id_catalog' );
    ...
    static function findByPosAndCat( $pos, $id_catalog ) {
        $finder = self::getFinder( __CLASS__ );
        $unlockIdobjCart = new \imei_service\mapper\UdidDetailsIdentityObject( 'id_catalog' );
