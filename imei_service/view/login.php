                                                ...
                                                <div id="shipping-user-address_section" class="user-address fieldset-content" style="">
                                                    <div class="mbs" style="">
                                                        <span class="login-field field-with-placeholder" style="">
                                                            ...
                                                            <input id="login" class="login" type="text" maxlength="35" size="35" name="login">
                                                        </span>
                                                    </div>
                                                    <div class="mbs" style="">
                                                        <span class="password-field field-with-placeholder" style="">
                                                            ...
                                                            <input id="password" class="password" type="text" size="8" name="password">
                                                        </span>
                                                    </div>
                                                    <div class="mbs" style="">
                                    ...
                                    <div class="substep" style="">
                                        <div id="payment-form-astro" class="form-astro with-seperator">
                                            <p class="legend" style="">
                                                <a href="?cmd=Faq" class="metrics-link">Зарегистрироваться</a>
                                                <a href="?cmd=Faq" class="separated-link metrics-link">Забыли логин или пароль?</a>
                                            </p>
                                            <br />
                                            <p>
                                                <?php
