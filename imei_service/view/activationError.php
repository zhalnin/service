...
//    echo "<tt><pre>".print_r( $request , true ) ."</pre></tt>";
    ...
    $title = "Данные для активации устарели или не действительны";
        ...
        <div id="news-main" class="main-content">
            <div id="" class="news-content clear-fix">
                <div id='' class="news-header">
                    <h2  class="h2">Данные для активации устарели или не действительны</h2>
                </div>
                <div class='news-container'>
                    <div class='success-body'>
                        <div class='success-title'>
                            <h1 class=h2>Вы можете запросить повторное письмо для активации вашей учетной записи</h1>
                        </div>
