...
try {
    ...
    // выполняем переадресацию на страницу с регистрацией UDID
    print "<html><head>\n";
    print "<meta http-equiv='Refresh' content='7; url=?cmd=Udid'>\n";
    print "</head></html>\n";
    ...
    // содержимое тега meta
    $description    = "Оповещение о успешной отправки заявки на регистрацию UDID";
            ...
            <div id="news-main" class="main-content">
                <div id="" class="news-content clear-fix">
                    <div id='' class="news-header">
                        <h2  class="h2">Успешная заявка на регистрацию UDID</h2>
                    </div>
