                ...
                <div class='news-container'>
                    <div class='success-body'>
                        <div class='success-title'>
                            <h1 class=h2>Уважаемый, <?php echo $request->getProperty('last_name');?> <?php echo $_POST['first_name']; ?>, спасибо, что воспользовались нашим сервисом!</h1>
                        </div>
                        ...
                        <div class='success-info'>
                            <p>Пожалуйста, проверьте ваш адрес электронной почты: <?php echo $_POST['payer_email']; ?>, <br />
                                на который должно прийти уведомление PayPal о проведенной оплате.</p>
                            <p>Ваш заказ будет выполнен в установленные сроки.</p>
                            <p>По выполнении заказа мы вам вышлем уведомление на указанный электронный адрес.</p>
                            <p>Услуги 100% легальные.</p>
                            <p>
