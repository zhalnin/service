...
try {
    ...
    $title = "Ваша учетная запись на сайте imei-service.ru успешно активирована";
        ...
        <div id="news-main" class="main-content">
            <div id="" class="news-content clear-fix">
                <div id='' class="news-header">
                    <h2  class="h2">Ваша учетная запись на сайте imei-service.ru успешно активирована</h2>
                </div>
                <div class='news-container'>
                    <div class='success-body'>
                        <div class='success-title'>
                            <h1 class=h2>Вы можете войти на сайт imei-service.ru под своим логином и паролем</h1>
                        </div>
