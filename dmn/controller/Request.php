...
class Request {
    ...
    function __construct() {
        ...
        \dmn\base\RequestRegistry::setRequest( $this );    // кэшируем ее в классе Registry
    }
     ...
     * @param \dmn\command\Command $command
     */
    function setCommand( \dmn\command\Command $command ) {
