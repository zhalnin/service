...
class ArtParagraphSelectionFactory extends SelectionFactory {
    ...
    function newSelection( IdentityObject $obj ) {
        ...
        $core = "SELECT $fields FROM system_menu_paragraph";  // составляем запрос
    ...
    function newSelectionMaxPos( IdentityObject $obj ) {
        ...
        $core = "SELECT MAX( pos ) as pos FROM system_menu_paragraph";  // составляем запрос
        $orderby = " ORDER BY pos ";
