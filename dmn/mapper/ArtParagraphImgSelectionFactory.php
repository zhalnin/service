...
class ArtParagraphImgSelectionFactory extends SelectionFactory {
    ...
    function newSelection( IdentityObject $obj ) {
        ...
        $core = "SELECT $fields FROM system_menu_paragraph_image";  // составляем запрос
    ...
    function newSelectionMaxPos( IdentityObject $obj ) {
        ...
        $core = "SELECT MAX( pos ) as pos FROM system_menu_paragraph_image";  // составляем запрос
        $orderby = " ORDER BY pos ";
    ...
    function newSelectionCountPos( IdentityObject $obj ) {
        $fields = implode( ',', $obj->getObjectFields() );
        $core = "SELECT COUNT(*) as count FROM system_menu_paragraph_image";  // составляем запрос
        $orderby = "";
        list( $where, $values ) = $this->buildWhere( $obj );
