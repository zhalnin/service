...
class AccountsSelectionFactory extends SelectionFactory {
    ...
    function newSelection( IdentityObject $obj ) {
        ...
        $core = "SELECT $fields FROM system_accounts";  // составляем запрос
//        $orderby = " ORDER BY pos";
    ...
    function newSelectionCountPos( IdentityObject $obj ) {
        ...
        $core = "SELECT COUNT(*) as count FROM system_accounts";  // составляем запрос
        $orderby = "";
