...
class ArtCatalogSelectionFactory extends SelectionFactory {
    ...
    function newSelection( IdentityObject $obj ) {
        ...
        $core = "SELECT $fields FROM system_menu_catalog";  // составляем запрос
    ...
    function newSelectionMaxPos( IdentityObject $obj ) {
        ...
        $core = "SELECT MAX( pos ) as pos FROM system_menu_catalog";  // составляем запрос
        $orderby = " ORDER BY pos ";
