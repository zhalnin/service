...
//                echo "<tt><pre>". print_r($obj, TRUE) . "</pre></tt>";
    ...
    static function delete( $idc ) {
        ...
        $catParent = \dmn\domain\ArtUrl::find( $idc );
...
//            }
            ...
            $posParent = \dmn\domain\ArtUrlPosition::findAllPosition( $catParent->getId() );
...
//                    echo "<tt><pre> 1 - ".print_r($pos, true)."</pre></tt>";
                ...
                $catChild = \dmn\domain\ArtUrl::findParent( $catParent->getId() );
